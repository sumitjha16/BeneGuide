      ...
      <CardContent className="flex gap-4 p-6">
        ...
        <div className="flex-1 space-y-2">
          <div className="flex items-start justify-between gap-4">
            <h3 className="font-semibold text-brand-800 dark:text-text-strong text-lg leading-tight">
              {step.title}
            </h3>
            <Badge variant="outline" className="shrink-0 text-xs bg-elev-2 text-brand-700 dark:text-text-muted border-border">
              {step.estimated_time}
            </Badge>
          </div>
